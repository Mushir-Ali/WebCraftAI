...
import { Code, Code2, MessageCircle, MessageSquare, Monitor, Rocket, Send, X } from 'lucide-react';
        ...
        <div className='h-screen w-screen flex bg-black text-white overflow-hidden'>
            ...
            <div className='flex-1 flex flex-col'>
                <div className='h-14 px-4 flex justify-between items-center border-b border-white/10 bg-black/80'>
                    ...
                    <div className='flex gap-2'>
                        {website?.deployed ? "" : (<button className='flex items-center gap-2 px-4 py-1.5 rounded-lg bg-linear-to-r from-indigo-500 to-purple-500 text-sm font-semibold hover:scale-105 transition'><Rocket size={14} onClick={handleDeploy} />Deploy</button>)}
